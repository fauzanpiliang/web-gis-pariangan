...
function infoMarkerData(data, url, number_day = null) {
  let id = data.id;
  let name = data.name;
  ...
  if (window.location.pathname.split("/").pop() == "mobile") {
    ...
    infoMarker = `<div class="text-center mb-1">${name} </div>${(() => {
      if (number_day != null) {
        return `<div class="text-center mb-1"><i class="fa fa-calendar"></i> Day ${number_day}</div>`;
      } else {
        return "";
      }
    })()}${(() => {
...
function showPanelList(datas, url) {
  ...
  if (datas.length == 0) {
    listPanel.push(
      `<tr colspan="3"><td></td><td class="text-center text-dark">object not found!</td><td></td></tr>`
    );
  }
  ...
  for (let i = 0; i < datas.length; i++) {
    ...
    let lng = datas[i].lng;
    listPanel.push(
      `<tr><td class="text-dark">${
        i + 1
      }</td><td class="text-dark">${name} ${(() => {
        if (url == "event") {
  ...
  if (url == "atraction") {
    $("#panel").html(
      `<div class="card-header"><h5 class="card-title text-center text-dark">Atraction</h5></div><div class="card-body"><table class="table table-border overflow-auto" width="100%"><thead><tr><th>#</th><th class="text-dark">Name</th><th class="text-center text-dark">Action</th></tr></thead><tbody id="tbody">${listPanel}</tbody></table></div>`
    );
  }
  if (url == "event") {
    $("#panel").html(
      `<div class="card-header"><h5 class="card-title text-center text-dark">List event</h5></div><div class="card-body"><table class="table table-border overflow-auto" width="100%"><thead><tr><th>#</th><th class="text-dark">Name</th><th class="text-center text-dark">Action</th></tr></thead><tbody id="tbody">${listPanel}</tbody></table></div>`
    );
  }
  if (url == "culinary_place") {
    $("#panel").append(
      `<div class="card-header"><h5 class="card-title text-center">List culinary place</h5></div><div class="card-body"><table class="table table-border overflow-auto shadow" width="100%"><thead><tr><th>#</th><th class="text-dark">Name</th><th class="text-center text-dark">Action</th></tr></thead><tbody id="tbody">${listPanel}</tbody></table></div>`
    );
  }
  if (url == "souvenir_place") {
    $("#panel").append(
      `<div class="card-header"><h5 class="card-title text-center">List souvenir place</h5></div><div class="card-body"><table class="table table-border overflow-auto shadow" width="100%"><thead><tr><th>#</th><th class="text-dark">Name</th><th class="text-center text-dark">Action</th></tr></thead><tbody id="tbody">${listPanel}</tbody></table></div>`
    );
  }
  if (url == "worship_place") {
    $("#panel").append(
      `<div class="card-header"><h5 class="card-title text-center">List worship place</h5></div><div class="card-body"><table class="table table-border overflow-auto shadow" width="100%"><thead><tr><th>#</th><th class="text-dark">Name</th><th class="text-center text-dark">Action</th></tr></thead><tbody id="tbody">${listPanel}</tbody></table></div>`
    );
  }
  if (url == "facility") {
    $("#panel").append(
      `<div class="card-header"><h5 class="card-title text-center">List facility</h5></div><div class="card-body"><table class="table table-border overflow-auto shadow" width="100%"><thead><tr><th>#</th><th class="text-dark">Name</th><th class="text-center text-dark">Action</th></tr></thead><tbody id="tbody">${listPanel}</tbody></table></div>`
    );
  }
  if (url == "homestay") {
    $("#panel").append(
      `<div class="card-header"><h5 class="card-title text-center">List homestay</h5></div><div class="card-body"><table class="table table-border overflow-auto shadow" width="100%"><thead><tr><th>#</th><th class="text-dark">Name</th><th class="text-center text-dark">Action</th></tr></thead><tbody id="tbody">${listPanel}</tbody></table></div>`
    );
  }
}
