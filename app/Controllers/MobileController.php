...
class MobileController extends BaseController
{
    use ResponseTrait;
    protected $auth;
    protected $modelRating, $modelUser, $modelPariangan, $modelEvent, $modelAtraction, $modelPackage, $modelFp, $modelAc, $modelProduct, $modelSouvenir, $modelCulinary, $modelWorship, $modelFacility;
