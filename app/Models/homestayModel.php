...
class homestayModel extends Model
{
    ...
    // ----------------------------------------------Admin--------------------------------------
    public function addHomestay($id, $data, $lng, $lat, $geojson = null)
    {
    ...
    public function updateH($id, $data, $lng, $lat, $geojson = null)
    {
        $query = $this->db->table($this->table)
            ->where('homestay.id', $id)
            ->update($data);
    ...
    {
        $query = $this->db->table($this->table_gallery)->select('url')->where('homestay_id', $id)->get();
        return $query;
    }
    ...
    {
        return $this->db->table($this->table_gallery)->delete(['homestay_id' => $id]);
    }
}
