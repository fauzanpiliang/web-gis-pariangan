            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                        <div class="text-end">
                            <a href="<?= base_url('manage_homestay/edit/' . $objectData->id); ?>" role="button" class="btn btn-primary justify-item-center" title="edit"><i class="fa fa-edit"></i></a>
                        </div>
                        <h4 class="card-title text-center">Detail homestay</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
