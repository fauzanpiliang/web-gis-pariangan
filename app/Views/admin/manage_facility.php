...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary text-center">List Facility</h5>
            <a href="<?= base_url('manage_facility/insert') ?> " title="Add facility" role="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add</a>
        </div>
        <div class="card-body">
                                    ...
                                    <div class="modal fade" id="deleteModal<?= $facility->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">Are you sure delete <b>" <?= $facility->name; ?> "</b> facility?</div>
                                                <div class="modal-footer">
                                                    <a class="btn btn-danger" href="<?= base_url('manage_facility/delete/' . $facility->id) ?>">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
